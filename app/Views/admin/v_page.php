  ...
  <div class="row mb-3">
    <div class="col-lg-3 pt-1 pb-1">
      <form action="" method="GET">
        <input type="text" placeholder="Katakunci..." name="katakunci" class="form-control"
      ...
      foreach ($record as $value) {
        ...
        <tr>
          ...
          <td>
            ...
            <a href="<?php echo $link_delete ?>" onclick="return confirm('Yakin akan menghapus data ini?')"
